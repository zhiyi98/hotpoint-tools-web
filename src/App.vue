<template>
  <div class="relative bg-[#f2f2f2] h-screen">
    <div class="max-w-[1024px] min-w-[375px] m-auto border-x bg-white">
      ...
      <!--内容-->
      <div class="flex flex-col h-[calc(100vh-10rem+6px)] mx-4 pt-4 hidden-scrollbar overflow-y-auto">
        <div>
        ...
        <div class="flex block justify-center items-center space-x-2 mt-14 mb-4">
